...
export function ReportForm({ onComplete }: ReportFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 text-sm sm:text-[16px]">
      ...
      <div className="grid grid-cols-2 gap-4 items-center justify-center">
        ...
        >
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="font-medium text-sm text-red-500 sm:text-[16px]  ">Emergency</span>
        ...
        >
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="font-medium text-sm sm:text-[16px] text-orange-500">Non-Emergency</span>
            <span className="text-xs sm:text-sm text-zinc-400">General Report</span>
          </div>
        </button>
      </div>
